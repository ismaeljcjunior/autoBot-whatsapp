...
var import_cors2 = __toESM(require_lib());
...
require_main().config({ path: import_path.default.resolve(__dirname, "../.env") });
var sender = new services_default();
...
require_main().config({ path: import_path2.default.resolve(__dirname, "../.env") });
var app2 = (0, import_express2.default)();
var port2 = Number(process.env.PORT);
app2.use(import_express2.default.json());
app2.use((0, import_cors2.default)());
app2.use("/", appRoutes);
app2.listen(port2, () => {
  console.log("Conversor de Requisi\xE7\xE3o 1.0 is running on port", port2);
});
